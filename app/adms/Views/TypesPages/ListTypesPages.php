    ...
    <div class="row">
        ...
        <table class="table-list">
            ...
            <tbody class="list-body">
                <?php
                foreach ($this->data['listTypePgs'] as $typePgs) {
                    extract($typePgs);
                ?>
                    <tr>
                        <td class="list-body-content"><?php echo $id; ?></td>
                        <td class="list-body-content"><?php echo $type; ?> - <?php echo $name; ?></td>
                        <td class="list-body-content table-sm-none"><?php echo $order_type_pg; ?></td>
