    ...
    <div class="row">
        <div class="top-list">
            ...
            <div class="top-list-right">
                ...
                if (isset($valorForm['id'])) {
                    echo "<a href='" . URLADM . "view-page/index/" . $valorForm['id'] . "' class='btn-primary'>Visualizar</a><br><br>";
                }
                ?>
            </div>
        </div>
        ...
        <div class="content-adm">
            <form method="POST" action="" id="form-edit-pages" class="form-adm">
                ...
                <div class="row-input">
                    <div class="column">
                        ...
                        <select name="adms_sits_pgs_id" id="adms_sits_pgs_id" class="input-adm" required>
                            ...
                            <?php
                            foreach ($this->data['select']['situation'] as $sitPage) {
                                extract($sitPage);
                                if (isset($valorForm['adms_sits_pgs_id']) and $valorForm['adms_sits_pgs_id'] == $id_sit_pg) {
                                    echo "<option value='$id_sit_pg' selected>$name_sit_pg</option>";
                                } else {
                                    echo "<option value='$id_sit_pg'>$name_sit_pg</option>";
                                }
                            }
                            ?>
                        </select>
                ...
                <button type="submit" name="SendEditPage" class="btn-warning" value="Salvar">Salvar</button>
